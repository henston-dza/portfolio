        ...
        <div className="flex flex-wrap">
          <div className="w-full md:w-2/3 mb-8 md:mb-0 home-about-description">
            ...
            <p className="text-lg leading-relaxed text-justify md:p-10">
              I&apos;m a passionate Full Stack Developer from Karnataka, India,
              with a strong interest in building modern, user-centric web applications.
              My journey in technology has been driven by curiosity, continuous learning,
              and a desire to turn ideas into meaningful digital experiences.
              <br />
              <br />
